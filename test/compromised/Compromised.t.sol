...
contract CompromisedChallenge is Test {
    ...
    function test_compromised() public checkSolved {
        ...
        // The private keys for the first two sources can be decoded from the POST response in the readme file
        ...
        assertEq(oracle.getMedianPrice("DVNFT"), 0, "NFT price should be 0");

        tokenId = exchange.buyOne{value: 1}();
        ...
        assertEq(oracle.getMedianPrice("DVNFT"), EXCHANGE_INITIAL_ETH_BALANCE, "NFT price should not change");
